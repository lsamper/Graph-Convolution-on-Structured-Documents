...
def get_model():
    ...
    # AL
    adj_0_1, adj_1_1, adj_2_1 = Adjacency(n_features=50, max_nodes=50, name='adjacency1')(adj_list_1)
    ...
    # AL
    adj_0_2, adj_1_2, adj_2_2 = Adjacency(n_features=50, max_nodes=50, name='adjacency2')(adj_list_2)
    ...
    # AL
    adj_0_3, adj_1_3, adj_2_3 = Adjacency(n_features=50, max_nodes=50, name='adjacency3')(adj_list_3)
